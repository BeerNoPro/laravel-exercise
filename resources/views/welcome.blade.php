                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <a href="{{ route('students.list') }}" style="color: red">Curd students.</a>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <a href="{{ url("ajax-crud/ajax-crud-todo") }}" style="color: red">Crud ajax posts.</a>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <a href="{{ url('upload-file/images-list') }}" style="color: red">Upload file images to Amazon s3.</a>
                            </div>
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-2">
                        <div class="p-6">
                            <div class="flex items-center">
                                <a href="{{ url('handle-auth/dashboard') }}" style="color: red">Customer authentication</a>
                            </div>
                        </div>
                    </div>
                </div>
